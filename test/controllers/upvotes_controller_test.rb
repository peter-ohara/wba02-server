...
class UpvotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upvote" do
    assert_difference('Upvote.count') do
      post upvotes_url, params: { upvote: { comment_id: @upvote.comment_id, user_id: @upvote.user_id } }, as: :json
    end
  ...
  test "should update upvote" do
    patch upvote_url(@upvote), params: { upvote: { comment_id: @upvote.comment_id, user_id: @upvote.user_id } }, as: :json
    assert_response 200
  end
